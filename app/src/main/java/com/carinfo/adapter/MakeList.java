...
public class MakeList extends RecyclerView.Adapter {
    private RealmResults<CarMake> mHomeListData;
    private ImageLoader mImageLoader;

    public MakeList(RealmResults<CarMake> homeListData) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        CarMake make = mHomeListData.get(position);
        if (make != null) {
